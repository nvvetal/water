...
function wck_cptc_add_side_boxes(){
	add_meta_box( 'wck-cptc-side', 'Wordpress Creation Kit Pro', 'wck_cptc_side_box_one', 'wck_page_cptc-page', 'side', 'high' );
	add_meta_box( 'wck-cptc-side-two', 'Wordpress Creation Kit', 'wck_cptc_side_box_two', 'wck_page_cptc-page', 'side', 'high' );
}
...
function wck_cptc_side_box_two(){
	?> 
		<p class="cptc-message">
			IMPORTANT: The plugin Custom Post Type Creator will no longer be supported or updated. Custom Post Type Creator is now part of <a href="http://wordpress.org/extend/plugins/wck-custom-fields-and-custom-post-types-creator/" target="_blank">WCK - Custom Fields and Custom Post Types Creator plugin</a>, which is fully compatible. <a href="http://wordpress.org/extend/plugins/wck-custom-fields-and-custom-post-types-creator/" target="_blank">Download it</a> and install it instead of the current plugin.
		</p>
	<?php
}
