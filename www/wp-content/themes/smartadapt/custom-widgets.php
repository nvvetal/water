...
class WP_Widget_Feeds_smartadapt extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'widget_feeds', __( 'SmartAdapt: Feeds', 'smartadapt' ), $widget_ops );
	}
...
// Use current theme search form if it exists
	...
	<p><label style="width: 200px; float: left" for="<?php echo $this->get_field_id( 'checked_rss' ); ?>"><span style="float: left"><?php _e( 'Show RSS:', 'smartadapt' ); ?></span>
		<input 
	...
	<p><label style="width: 200px; float: left" for="<?php echo $this->get_field_id( 'checked_atom' ); ?>"><span style="float: left"><?php _e( 'Show ATOM:', 'smartadapt' ); ?></span>
		<input 
...
function smartadapt_add_theme_widgets($old_theme, $WP_theme = null) {
    ...
    $theme_mods = get_option('theme_mods_smartadapt');
