    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <header class="entry-header">
            ...
            <h2 class="entry-title">
                <div class="thumbnail-outer format-ico <?php echo $post_format.'-ico' ?>"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr(sprintf(__('Permalink to %s', 'smartadapt'), the_title_attribute('echo=0'))); ?>"><?php the_post_thumbnail('thumbnail'); ?></a></div>
                ...
                <a href="<?php the_permalink(); ?>"
                   title="<?php echo esc_attr(sprintf(__('Permalink to %s', 'smartadapt'), the_title_attribute('echo=0'))); ?>"
                   rel="bookmark" style="font-size: 23px; color: indianred; margin-left: 30px;">
                    Подробнее...
                </a>
            </h2>
        ...
        <div class="row">
            <div class="columns sixteen">
                ...
                if ('' != get_the_post_thumbnail()) {
                    ?>
<!--                   <div class="thumbnail-outer format-ico --><?php //echo $post_format.'-ico' ?><!--"><a href="--><?php //the_permalink(); ?><!--" title="--><?php //echo esc_attr(sprintf(__('Permalink to %s', 'smartadapt'), the_title_attribute('echo=0'))); ?><!--">--><?php //the_post_thumbnail('single-post-small'); ?><!--</a></div>-->
